...
El objetivo de esta práctica es realizar un estudio de un subconjunto del Dataset de incidentes KDD CUP 99 para determinar cual es el mejor conjunto de variables que podamaos usar en un entrenamiento de Machine Learnings y Finalmente conseguir un juego de Dataset y modelo de entreno que mejore el valor obtenido por el script del enunciado.
...
#setRepositories(addURLs = c(CRANxtras = "https://www.stats.ox.ac.uk/pub/RWin"))
...
#,"tidyverse", "DataExplorer", "ggridges", "hrbrthemes", "viridisLite", "viridis", "packcircles", "ggiraph", "Hmisc", "lubridate", "plotly", "formattable", "visNetwork", "sjmisc", "rworldmap", "stringr", "maps", "RJSONIO")
# Instalar y cargar los paquetes faltantes
#ipak(mypackages)
...
```{r study_sample_data, echo=TRUE, results='hide'}
...
El conjunto de datos de muestra tiene 77.291 filas y 42 columnas. `r dim(data)`.
...
Contiene `r print(num_qualitative)` variable numéricas cuantitativas y `r print(num_quantitative)` variables cualitativas, estas las columnas son: "ProtocolType", "Service", "Flag" y "Attack", que representa la variable objetivo.
